    ...
    public class AIController : MonoBehaviour
    {
        ...
        private void ActionFindNewMovePosition()
        {
            if (aIBehavior == AIBehavior.Patrol)
            {
                ...
                {
                    if (patrolPoint != null && patrolControlPoints != null)
                    {
                        ...
                        if (isInsidePatrolZone)
                        {
                            ...
                            if (timer >= evadeDuration)
                            {
                                movePosition = patrolControlPoints[numPatrolPoint].position;
                            ...
                            if (randomizeDirectionTimer.IsFinished)
                            {
                                ...
                                if (numPatrolPoint >= patrolControlPoints.Length)
                                    numPatrolPoint = 0;
